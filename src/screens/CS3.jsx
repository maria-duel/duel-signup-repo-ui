...
export default function CS3({ onNext }) {
  return (
        ...
        <div style={{ padding: '0 16px 24px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 0 }}>
          ...
          <div style={{
            ...
            <p style={{
              ...
              You requested a magic link to view your application status. Tap the button below to securely access your status page — no password needed.
            </p>
            ...
            <p style={{
              ...
              margin: 0, lineHeight: '18px', textAlign: 'center',
              fontFamily: "'DM Sans', sans-serif",
            }}>
              You're receiving this because you requested access to your NARS Friends with Benefits application status.
            </p>
          </div>

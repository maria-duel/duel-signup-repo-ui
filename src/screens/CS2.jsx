...
export default function CS2({ email, onNext }) {
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <p style={{ fontSize: 14, color: 'rgba(255,255,255,0.5)', margin: 0, lineHeight: '20px' }}>
            Tap the link to view your application status.<br />No password needed.
          </p>
        </div>
      ...
      <div style={{
        ...
        >
          {seconds > 0 ? (
            <>Resend magic link (<span key={seconds} style={{ display: 'inline-block', animation: 'timerTick 300ms ease' }}>{seconds}s</span>)</>
          ) : 'Resend magic link'}
        </button>
      </div>
    </div>
